...
df_quarterly_LIC_reserves_undiscounted_base_output <- outpu_calculator(input = df_LIC_reserves_base_input, table = quarterly_LIC_reserves_undiscounted_base)
...
df_discount_cashflow_base <- discounting(input = df_cashflow_cashflow_undiscounted_base_output, discount = df_discount_rates_base, 
                                         table = quarterly_cashflow_undiscounted_base)
